...
public class book{
	...
	try
	{
	String url= "jdbc:mysql://localhost:3308/revature";
	String username="root";
	String pass="Prasanth@143";
	...
	public void car_washing() throws SQLException {
			System.out.println("***Please enter User details***");
			 ...
			 String s1 = "insert into car_washing(name,address,date) values(?,?,?)";
	...
	public void electrician() throws SQLException {
		System.out.println("***Please enter your details***");
		 Connection con = getconn();
		 String s1 = "insert into electrician (name,address,date) values(?,?,?)";
		 PreparedStatement stmt = con.prepareStatement(s1);
	...
	public void Tv_repair() throws SQLException {
			System.out.println("***Please enter your details***");
			 Connection con = getconn();
			 String s1 = "insert into Tv_repair (name,address,date) values(?,?,?)";
			 PreparedStatement stmt = con.prepareStatement(s1);
